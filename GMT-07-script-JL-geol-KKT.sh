...
EOF
# Step-15. generate point and angle of great circle
gmt project -C151.6E/45.8N -A43 -G10 -L-3/7 > great_circle.txt
# Step-16. optional: plot a thick ribbon-like line of circle path
#gmt psxy -R -J -Wfattest,white -DjBL great_circle.txt -O -K  >> $ps
# Step-17. Add text along the curved path
